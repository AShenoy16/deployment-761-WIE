...
export const updateSpecByName = async (req: Request, res: Response) => {
	...
	try {
		...
		specialization.careerPathways = careerPathways ? JSON.parse(careerPathways) : specialization.careerPathways;
...
export const addTestimonialsBySpecName = async (req: Request, res: Response) => {
...
export const deleteTestimonial = async (req: Request, res: Response) => {
	...
	try {
		...
		specialization.testimonials = specialization.testimonials.filter((testimonial: ITestimonial) => testimonial._id.toString() !== testimonialId);
		specialization.save();
		const testimonials = specialization.testimonials;
